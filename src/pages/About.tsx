    ...
    <>
      ...
      <div class={styles.section}>
        <Section text={createHeaderToggle("Art")}>
          ...
          <Section text={{ show: "show thoughts", hide: "hide thoughts" }}>
            <p>
              ...
              I often have these grandious ideas that I can see form to completion in my head, but am unable to make a reality.

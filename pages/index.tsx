        ...
        <div className='z-30'>
          ...
          :(
            <div className={`flex flex-row items-center justify-center`}>
              ...
              <div className={`elementRemove w-1 h-[30vh] rounded-full dark:bg-gray-800 bg-gray-300 mx-5`}></div>
              ...
              <div className='w-[35vw] max-w-[600px]'>
                ...
                <a className='text-transparent bg-clip-text bg-gradient-to-r from-[#659AD2] via-[#00599C] to-[#004482] font-semibold'> C++</a>.<br/><br/>
                I currently work as a Senior Engineer at <a className='font-semibold hover:underline text-[#7ED957]' href='https://onegr.id/'>OneGrid</a>.
                </p>
